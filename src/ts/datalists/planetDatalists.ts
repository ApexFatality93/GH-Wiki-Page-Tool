function getSentinelData(): Record<string, string[]> {
	const sentinels = {
		low: [
			'Absent',
			'Few',
...
function getResourceData(): Record<string, string> {
	const resources = {
		'Copper': 'Cu',
		'Cadmium': 'Cd',
		'Emeril': 'Em',
...
function getDescriptorData(): Record<string, Record<string, string[]>> {
...
(() => {
	const planetDatalists: Record<string, string[]> = {
		weatherData: [
			'Tropical Storms',
