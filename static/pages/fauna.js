"use strict";
const faunaWindow = window;
const faunaPageData = pageData;
const faunaInputs = globalElements.input;
const faunaOutputs = globalElements.output;
...
function genderProps(property1Name, property2Name) {
    ...
    const property1Value = faunaPageData[property1Name];
    const property2Value = faunaPageData[property2Name];
    let property1Number;
    let property2Number;
