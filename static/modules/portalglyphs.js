...
const portalPageData = pageData;
const portalInputs = globalElements.input;
const portalOutputs = globalElements.output;
(() => {
    const glyphs = [];
    ...
    portalOutputs.portalglyphButtons.addEventListener('click', (event) => {
